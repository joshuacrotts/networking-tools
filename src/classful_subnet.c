...
compute_classful_subnet() {
  ...
  printf( "Enter the classful Class A, B, or C for the *subnet* (in hex WITH 0x prefix e.g. "
          "0xff000000, 0xffff0000, 0xffffff00): " );
  scanf( "%x", &classfulSubnet );
  printf( "\n" );

  // Given mask by the problem.
  printf( "Enter the classful Class A, B, or C for the *mask* (in hex WITH 0x prefix e.g. "
          "0xff000000, 0xffff0000, 0xffffff00): " );
  scanf( "%x", &subnetMask );
  printf( "\n" );
